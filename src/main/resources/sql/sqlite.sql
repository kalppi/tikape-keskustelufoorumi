...
CREATE TABLE Users (id INTEGER PRIMARY KEY, name VARCHAR(255) UNIQUE, pw_hash VARCHAR(88), admin INTEGER);
CREATE TABLE Categories (id INTEGER PRIMARY KEY, name VARCHAR(255) UNIQUE);
